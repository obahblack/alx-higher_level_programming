...
class TestBase(unittest.TestCase):
    ...
    def test_to_json_string(self):
        ...
        self.assertTrue(strd01, [{"id": 1, "width": 2, "height": 3, "x": 4, "y": 5}, {"id": 6, "width": 7, "height": 8, "x": 9, "y": 10}])
    ...
    def test_from_json_string(self):
        ...
        self.assertTrue(type(strs0[0] == list)
        self.assertTrue(type(strs0, [{"id": 1, "width": 2, "height": 3, "x": 4, "y": 5}, {"id": 6, "width": 7, "height": 8, "x": 9, "y": 10}])
        self.assertTrue(strs0[0], {"id": 1, "width": 2, "height": 3, "x": 4, "y": 5})

    def test_from_none_json_string(self):
        """Test no json string tranlates into empty python dict"""
        s2 = None
        str2 = Base.from_json_string(s2)
        self.assertTrue(type(strs2) == list)
        self.assertTrue(strs2 == [])

    def test_from__empty_json_string(self):
    ...
    with open("Rectangle.json", "r") as file:
        self.assertEqual(json.dumps([r.to_dictionary(), r2.to_dictionary()]), file.read())
    ...
    def test_load_from_non_file(self):
