...
class TestBase(unittest.TestCase):
    ...
    def test_default_attr(self):
        """Test defualt attributes are set when not given"""
        r2 = Rectangle(3, 4)
    ...
    def test_update(self):
        ...
        r.update(nokey=1000, invalid=2000, testin=300, id=4000)
        ...
        def test_to_dictionary(self):
            ...
            r2 = Rectangle(10, 10)
            r2.update(**rdic)
            self.assertEqual(str(r2), '[Rectanngle] (5) 3/4 - 1/2')
